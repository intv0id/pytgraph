...
# -*- coding: utf-8 -*-
#
# pytgraph documentation build configuration file
#
...
project = 'pytgraph'
copyright = '2019, Clément Trassoudaine'
...
_version_py = os.path.join(repo, 'pytgraph', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'pytgraph.tex', 'pytgraph Documentation',
     'Clément Trassoudaine', 'manual'),
]
